window.onload = function(){
	...
	/*开机动画结束*/
		...
		var aBot1 = oXxbg1.getElementsByClassName('xxbot1')[0];//获取自我描述页面最后的焦点样式
		var _this1= 1;
		...
		var aTimeArr = ['','','','','','','',''] //记录时间
		var aTimeArr1 = ['工作职位：敬请期待','工作职位：敬请期待','工作职位：敬请期待','工作职位：敬请期待','工作职位：敬请期待','工作职位：敬请期待','工作职位：敬请期待','工作职位：敬请期待']//工作时间
		var aTimeArr2 = [
				'敬请期待',
				'敬请期待',
				'敬请期待',
